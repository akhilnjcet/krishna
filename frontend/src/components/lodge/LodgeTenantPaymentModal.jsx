    ...
    <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-3xl w-full shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-300 max-h-[90vh] flex flex-col">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 p-6 text-white flex justify-between items-center relative overflow-hidden flex-shrink-0">
          <div className="absolute right-0 top-0 w-32 h-32 bg-white/10/10 dark:bg-slate-900/10 rounded-full blur-2xl -mr-10 -mt-10"></div>
          <div>
            <span className="px-3 py-1 bg-white/20/20 dark:bg-slate-900/20 text-white rounded-full text-[10px] font-black uppercase tracking-widest">
          ...
          <div className="flex items-center gap-2 relative z-10">
            ...
            <button 
              onClick={onClose}
              className="p-2.5 bg-white/10/10 dark:bg-slate-900/10 hover:bg-white/20/20 dark:bg-slate-900/20 text-white rounded-2xl transition-all"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
        ...
        {submittedSuccess ? (
          ...
          <div className="p-6 overflow-y-auto space-y-6 flex-1">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 p-5 rounded-2xl border border-slate-200/80/80 dark:border-slate-700/80">
                  ...
                  <div className="pt-2 border-t border-white/10 flex items-center justify-between text-[11px] text-slate-300">
                    ...
                    <div className="flex items-center gap-1.5">
                      <button 
                        ...
                        className="px-2.5 py-1 bg-white/10/10 dark:bg-slate-900/10 hover:bg-white/20/20 dark:bg-slate-900/20 rounded-lg text-white font-bold flex items-center gap-1"
                      >
            ...
            {paymentMethod === 'Bank Transfer' && (
              <div className="bg-slate-900 text-white p-6 rounded-3xl space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div className="bg-white/5/5 dark:bg-slate-900/5 p-3 rounded-xl border border-white/10">
                  ...
                  <div className="bg-white/5/5 dark:bg-slate-900/5 p-3 rounded-xl border border-white/10 flex justify-between items-center">
                    <div>
                    ...
                    <button type="button" onClick={() => copyToClipboard(paymentSettings.accountNumber, 'acc')} className="p-2 bg-white/10/10 dark:bg-slate-900/10 hover:bg-white/20/20 dark:bg-slate-900/20 rounded-lg text-white">
                  ...
                  <div className="bg-white/5/5 dark:bg-slate-900/5 p-3 rounded-xl border border-white/10 flex justify-between items-center">
                    ...
                    <button type="button" onClick={() => copyToClipboard(paymentSettings.ifsc, 'ifsc')} className="p-2 bg-white/10/10 dark:bg-slate-900/10 hover:bg-white/20/20 dark:bg-slate-900/20 rounded-lg text-white">
              ...
              <div className="bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-600">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    <label className="bg-white dark:bg-slate-900 hover:bg-slate-100/80 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 px-3.5 py-2 rounded-xl text-xs font-bold border border-slate-200 dark:border-slate-700 cursor-pointer flex items-center gap-1.5 shadow-sm">
                    ...
                    <button
                      ...
                      className="bg-white dark:bg-slate-900 hover:bg-slate-100/80 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 px-3.5 py-2 rounded-xl text-xs font-bold border border-slate-200 dark:border-slate-700 flex items-center gap-1.5 shadow-sm"
                    >
        ...
        {!submittedSuccess && (
          <div className="p-5 bg-slate-50 dark:bg-slate-800 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between flex-shrink-0">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 hover:bg-slate-100/80 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 hover:border-slate-300 dark:border-slate-600 rounded-xl font-bold text-xs flex items-center gap-2 shadow-sm transition-all"
            >
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in-95 border border-slate-100 dark:border-slate-800 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b pb-3">
              ...
              <button 
                ...
                className="p-2 bg-slate-100/80 dark:bg-slate-800/80 hover:bg-slate-200 text-slate-700 dark:text-slate-300 rounded-2xl transition"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
