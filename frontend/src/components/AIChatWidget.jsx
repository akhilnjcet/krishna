                    ...
                    >
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-4 py-2 flex gap-2 overflow-x-auto mx-auto scrollbar-hide w-full">
                            {contactSettings.primaryPhone ? (
                                ...
                                <button 
                                    disabled 
                                    className="flex-shrink-0 flex items-center gap-1.5 text-[11px] font-bold bg-slate-100/80 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 px-3 py-1.5 rounded-full text-slate-400 cursor-not-allowed"
                        ...
                        {/* Chat Body */}
                        <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50/50/50 dark:bg-slate-800/50">
                            {messages.map((msg, i) => (
                        ...
                        <div className="p-3 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700">
                            <form onSubmit={handleSend} className="flex items-center gap-2 relative">
                                <input 
                                    ...
                                    className="flex-1 bg-slate-100/80 dark:bg-slate-800/80 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-brand-accent/20 transition-all border border-transparent focus:border-brand-accent/50 pr-12"
                                />
