            ...
            <AnimatePresence>
                {(showAddModal || showEditModal) && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                        ...
                        >
                            <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50/50 dark:bg-slate-800/50">
                                <div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm overflow-y-auto">
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-3 text-xs bg-slate-50 dark:bg-slate-800 p-4 rounded-2xl border border-slate-200/60/60 dark:border-slate-700/60">
                                ...
                                <div className="flex gap-3 pt-2">
                                    <button 
                                        ...
                                        className="flex-1 px-4 py-3.5 rounded-2xl bg-slate-100/80 dark:bg-slate-800/80 text-slate-500 dark:text-slate-400 font-bold text-[9px] uppercase tracking-widest hover:bg-slate-200 transition"
                                    >
                                        Cancel
                                    </button>
                                    <button 
