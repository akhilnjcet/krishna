                ...
                >
                    ...
                    <div className="p-10">
                        ...
                        <div className="mt-8 text-center space-y-4">
                            <div className="text-[10px] font-black tracking-widest uppercase text-brand-400">
                                UNAUTHORIZED ACCESS IS STRICTLY MONITORED
                            </div>
                            <div className="pt-4 border-t-2 border-brand-50">
                                <button 
                                    onClick={() => navigate('/register')}
                                    className="text-[10px] font-black tracking-widest uppercase text-brand-600 hover:text-brand-950 transition-colors"
                                >
                                    New Client? Initialize Account &rarr;
                                </button>
                            </div>
                        </div>
                    </div>
