...
const PaymentSystem = () => {
    ...
    const handlePayment = (method) => {
        ...
        setTimeout(() => {
            ...
            setProcessing(false);
            setSuccess(true);
            setTimeout(() => navigate(`/lodge/room/${roomNumber}`), 2500);
        }, 1500);
    };
        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-white">
                <motion.div 
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="w-24 h-24 bg-emerald-50 rounded-full flex items-center justify-center mb-8 border-4 border-emerald-100"
                >
                    <CheckCircle2 className="w-12 h-12 text-emerald-500" />
                </motion.div>
                <h1 className="text-2xl font-black text-slate-800 mb-2 font-poppins text-center">Transaction Validated</h1>
                <p className="text-slate-500 font-medium text-center">Receipt has been generated and saved. Redirecting...</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="bg-[#2D5BE3] pt-12 pb-20 px-6 relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-white font-poppins capitalize">{type} Settlement</h1>
                </div>
            </div>
            ...
            <div className="px-6 -mt-10 pb-12 max-w-lg mx-auto">
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-xl shadow-blue-900/5 border border-slate-100 text-center">
                        ...
                        <p className="text-xs font-bold text-indigo-500 uppercase tracking-wider">Room {roomNumber} • Krishna Building</p>
                    </div>
