    ...
    if (success) {
        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-white dark:bg-slate-900">
                ...
                <h1 className="text-2xl font-black text-slate-800 dark:text-slate-200 mb-2 font-poppins text-center">
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-800">
            ...
            <div className="px-6 -mt-6 pb-12 max-w-lg mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    {!showQR && (
                        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-xl shadow-blue-900/5 border border-slate-100 dark:border-slate-800 text-center">
                            ...
                            <div className="flex items-center justify-center gap-1 mb-2">
                                ...
                                <input 
                                    ...
                                    className="text-5xl font-black text-slate-900 dark:text-white w-full max-w-[200px] text-center bg-transparent border-0 focus:ring-0 p-0"
                                />
                            </div>
                    ...
                    {/* QR Code Section */}
                    {showQR && (
                        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-slate-100 dark:border-slate-800 flex flex-col items-center">
                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200 mb-2 font-poppins">Pay ₹{amount}</p>
                            ...
                            <img 
                                ...
                                alt="UPI QR Code" 
                                className="w-48 h-48 rounded-2xl border-4 border-slate-100 dark:border-slate-800 object-cover mb-8 shadow-sm"
                            />
                            ...
                            {screenshotPreview && (
                                <img src={screenshotPreview} alt="Screenshot" className="w-full max-h-32 object-contain mt-4 rounded-xl border border-slate-100 dark:border-slate-800" />
                            )}
                        ...
                        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-xl shadow-blue-900/5 border border-slate-100 dark:border-slate-800">
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    disabled={processing}
                                    className="w-full flex items-center justify-between p-5 bg-slate-50 dark:bg-slate-800 rounded-2xl border-2 border-transparent hover:border-[#2D5BE3]/30 transition-all group"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-white dark:bg-slate-900 rounded-xl shadow-sm flex items-center justify-center text-emerald-600">
                                            <Smartphone className="w-6 h-6" />
                                        </div>
                                        <div className="text-left">
                                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200">Unified Payments Interface</p>
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="text-left">
                                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200">Direct Cash Settlement</p>
            ...
            {/* Loading Overlay */}
            {processing && (
                <div className="fixed inset-0 bg-white dark:bg-slate-900/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center">
