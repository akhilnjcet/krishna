...
const RoomDashboard = () => {
    ...
    const generateReceipt = async () => {
        ...
        doc.text(`STAY SUMMARY - ROOM ${room.number}`, 105, 20, { align: "center" });

        const data = [
            ["Tenant Name", room.tenant || "N/A"],
            ["Room Number", room.number],
            ["Monthly Rent", `INR ${room.rent}`],
            ["Advance Paid", `INR ${room.advance || 0}`],
        ...
        doc.text("Generated by KRISHNA ERP Lodge Manager - Automated Cloud Record.", 105, doc.lastAutoTable.finalY + 15, { align: "center" });
        await savePDF(doc, `ROOM_${room.number}_STAY_RECORD.pdf`);
    };
